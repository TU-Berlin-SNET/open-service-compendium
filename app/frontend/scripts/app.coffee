...
angular.module('frontendApp', [
  ...
  $stateProvider
    ...
    .state('services.info.dynamic', url:'questionnaire/dynamic/', templateUrl: 'dynamicQuestionnaire.html', controller: 'DynamicQuestionnaireController')
    .state('services.info.static', url:'questionnaire/static/', templateUrl: 'staticQuestionnaire.html', controller: 'StaticQuestionnaireController')
    .state('services.info.staticDetails', url:'questionnaire/static/csModel?:csmKey/', templateUrl: 'staticQuestionnaireDetails.html', controller: 'StaticQuestionnaireDetailsController', params: { csmKey: null})
